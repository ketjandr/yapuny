  ...
  return (
    <section className="grp">
      ...
      <div className={`cfg${expanded ? " grid2" : ""}`}>
        ...
        <CfgSlider label="p_dropout" help="Randomly ignores this fraction of the network each step to prevent overfitting." value={meta.dropout} min={0} max={0.5} step={0.05} float onChange={(v) => setMeta({ dropout: v })} />
